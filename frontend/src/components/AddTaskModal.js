            ...
            >
              <Dialog.Panel className="rounded-lg bg-purple-50 shadow-xl w-full max-w-md lg:max-w-3xl mx-auto">
                ...
                <Dialog.Title as="div" className="bg-purple-100 shadow px-6 py-4 rounded-t-md sticky top-0 flex justify-between items-center">
                  {!edit ? (
                    <h1 className="text-lg font-bold text-purple-800">Add Task</h1>
                  ) : (
                    <h1 className="text-lg font-bold text-purple-800">Edit Task</h1>
                  )}
                  <button onClick={() => setAddTaskModal(false)} className="text-purple-500 hover:bg-purple-200 rounded-full p-2 focus:outline-none focus:ring focus:ring-offset-1 focus:ring-purple-300">
                ...
                <form onSubmit={handleSubmit} className="px-8 py-6 space-y-4 bg-purple-50">
                  ...
                  <div className="flex justify-end items-center space-x-2">
                    <button type="button" onClick={() => setAddTaskModal(false)} className="bg-purple-200 text-purple-700 rounded-md px-4 py-2 hover:bg-purple-300 focus:outline-none focus:ring focus:ring-purple-300">
                      Cancel
                    </button>
